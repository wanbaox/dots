...
DataController* DataController::getSharedDataController()
{

}

void DataController::releaseSharedDataController()
{

}

void DataController::savePlayerTemplateData(int score)
{

}

CCArray * DataController::readLoaclScoreTopList()
{

}

CCDictionary * DataController::readWorldScpreTopList()
{

}

CCArray * DataController::readPlayerDefaultProperty()
{

}

int DataController::getHighScore()
{

    
}

void DataController::saveUserName(CCString name)
{
...
//        _sharedDataController = DataController::create();
//    }
